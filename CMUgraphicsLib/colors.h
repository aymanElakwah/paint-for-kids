...
public:
	...
	color(unsigned char Red = 0, unsigned char Green = 0, unsigned char Blue = 0, std::string name = "Strange Color") {
...
const color DIMGREY = color(105, 105, 105, "DIM GREY");
...
const color DODGERBLUE = color(30, 144, 255, "DODGER BLUE");
...
const color MEDIUMTURQUOISE = color(72, 209, 204, "TURQUOISE");
...
const color SEAGREEN = color(46, 139, 87, "SEA GREEN");
...
const color LIMEGREEN = color(50, 205, 50, "LIME GREEN");
